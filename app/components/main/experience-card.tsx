...
const ExperienceCard: React.FC<ExperienceCardProps> = ({
  ...
  return (
    <div className='group relative grid py-1.5 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:opacity-100! lg:group-hover/list:opacity-50'>
      ...
      <header
        className='z-10 dark:group-hover:text-slate-300 mb-2 mt-1 text-xs font-semibold uppercase tracking-wide text-slate-600 dark:text-slate-500 sm:col-span-2'
        aria-label={date}
      >
        {date}
      </header>
