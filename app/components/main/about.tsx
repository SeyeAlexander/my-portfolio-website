...
const AboutSection = () => {
  return (
    <>
      <div className='flex flex-col gap-4 text-slate-900 dark:text-slate-300 text-[15px]'>
        <p>
          I'm a{" "}
        ...
        <p>
          Right now, I'm a Senior Frontend Developer at EStation, where I focus on architecting
          high-performance Next.js applications and building scalable design systems. Previously, I
          led frontend development at Neue World, creating platforms like{" "}
          <span className='text-indigo-600 dark:text-indigo-400'>Flozi,</span> which connects{" "}
          <span className='text-indigo-600 dark:text-indigo-400'>
